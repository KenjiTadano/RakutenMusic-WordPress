(function () {
  ...
  function registerCampaignHeroBlock() {
    ...
    wp.blocks.registerBlockType(BLOCK_NAME, {
      ...
      icon: "cover-image",
      description: __(
        "キャンペーンページ用ヒーロー（PC/SP画像・背景・スケジュール・注釈を編集可能）",
        "rakutenmusic-theme",
      ),
      attributes: {
      ...
      edit: function (props) {
        ...
        var blockProps = useBlockProps
          ? useBlockProps({ className: "campaign-hero-block-editor" })
          : { className: "campaign-hero-block-editor" };
        function resolveAssetUrl(url) {
          if (!url || !url.trim()) return "";
          var u = url.trim();
          if (/^https?:\/\//i.test(u) || u.indexOf("//") === 0) return u;
          var base =
            (typeof rakutenmusicCampaignHero !== "undefined" &&
              rakutenmusicCampaignHero.assetsUri) ||
            "";
          if (u.indexOf("/assets/") === 0) return base + u.slice(7);
          if (u.indexOf("assets/") === 0) return base + "/" + u;
          return u;
        }

        var heroBgStyle = {};
        if (attrs.heroBackgroundImage) {
          var resolvedBg = resolveAssetUrl(attrs.heroBackgroundImage);
          heroBgStyle.backgroundImage = resolvedBg
            ? "url(" + resolvedBg + ")"
            : "";
          heroBgStyle.backgroundRepeat =
            attrs.heroBackgroundRepeat || "no-repeat";
          var pos = attrs.heroBackgroundPosition || "center top";
          if (
            attrs.heroBackgroundPositionY &&
            /^-?\d+$/.test(String(attrs.heroBackgroundPositionY).trim())
          ) {
        ...
        var scheduleStyle = {};
        if (attrs.scheduleBackgroundColor) {
          scheduleStyle.backgroundColor = attrs.scheduleBackgroundColor;
        }
        if (attrs.scheduleFontSize) {
          scheduleStyle.fontSize = attrs.scheduleFontSize;
        }
        if (attrs.scheduleTextColor) {
          scheduleStyle.color = attrs.scheduleTextColor;
        }
        if (
          attrs.scheduleTextOffsetY &&
          /^-?\d+$/.test(String(attrs.scheduleTextOffsetY).trim())
        ) {
          scheduleStyle["--schedule-text-offset-y"] =
            attrs.scheduleTextOffsetY.trim() + "px";
        }
        if (
          attrs.scheduleNoteOffsetY &&
          /^-?\d+$/.test(String(attrs.scheduleNoteOffsetY).trim())
        ) {
          scheduleStyle["--schedule-note-offset-y"] =
        ...
        var imgPc =
          attrs.imagePcUrl && attrs.imagePcUrl.trim()
            ...
            : defaultPc;
        var imgSp =
          attrs.imageSpUrl && attrs.imageSpUrl.trim()
            ? resolveAssetUrl(attrs.imageSpUrl)
            : defaultSp;
          ...
          el(
            ...
            el(
              ...
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ imagePcUrl: v });
                },
              }),
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ imagePcAlt: v });
                },
              }),
            ),
            el(
              ...
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ imageSpUrl: v });
                },
              }),
              el(TextControl, {
                label: __("altテキスト", "rakutenmusic-theme"),
                ...
                onChange: function (v) {
                  props.setAttributes({ imageSpAlt: v });
                },
              }),
            ),
            el(
              PanelBody,
              {
                title: __("ヒーロー背景", "rakutenmusic-theme"),
                initialOpen: false,
              },
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundImage: v });
                },
              }),
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundColor: v });
                },
              }),
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundRepeat: v });
                },
              }),
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundPosition: v });
                },
              }),
              el(TextControl, {
                label: __(
                  "背景の縦オフセット (px)。下へ: 正の数、上へ: 負の数",
                  "rakutenmusic-theme",
                ),
                value: attrs.heroBackgroundPositionY || "",
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundPositionY: v });
                },
              }),
              el(TextControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ heroBackgroundSize: v });
                },
              }),
            ),
            el(
              PanelBody,
              {
                title: __("スケジュール", "rakutenmusic-theme"),
                initialOpen: true,
              },
              el(CheckboxControl, {
                ...
                onChange: function (v) {
                  props.setAttributes({ scheduleVisible: v });
                },
              }),
              attrs.scheduleVisible
                ? el(
                    ...
                    el(TextControl, {
                      ...
                      onChange: function (v) {
                        props.setAttributes({ scheduleBackgroundColor: v });
                      },
                    }),
                    el(TextControl, {
                      ...
                      onChange: function (v) {
                        props.setAttributes({ scheduleFontSize: v });
                      },
                    }),
                    el(TextControl, {
                      ...
                      onChange: function (v) {
                        props.setAttributes({ scheduleTextColor: v });
                      },
                    }),
                    el(TextControl, {
                      label: __(
                        "開始終了テキストの縦オフセット (px)。下: 正、上: 負",
                        "rakutenmusic-theme",
                      ),
                      value: attrs.scheduleTextOffsetY || "",
                      onChange: function (v) {
                        props.setAttributes({ scheduleTextOffsetY: v });
                      },
                    }),
                    el(TextControl, {
                      label: __(
                        "注釈の縦オフセット (px)。下: 正、上: 負",
                        "rakutenmusic-theme",
                      ),
                      value: attrs.scheduleNoteOffsetY || "",
                      onChange: function (v) {
                        props.setAttributes({ scheduleNoteOffsetY: v });
                      },
                    }),
                    el(CheckboxControl, {
                      ...
                      onChange: function (v) {
                        props.setAttributes({ scheduleAlwaysOn: v });
                      },
                    }),
                    attrs.scheduleAlwaysOn
                      ...
                      : el(
                          ...
                          el(TextControl, {
                            ...
                            onChange: function (v) {
                              props.setAttributes({ scheduleStartDate: v });
                            },
                          }),
                          el(TextControl, {
                            ...
                            onChange: function (v) {
                              props.setAttributes({ scheduleEndDate: v });
                            },
                          }),
                        ),
                    el(CheckboxControl, {
                      label: __(
                        "注釈を表示する（※進呈するポイント...詳細はこちら）",
                        "rakutenmusic-theme",
                      ),
                      checked: attrs.scheduleNoteVisible,
                      onChange: function (v) {
                        props.setAttributes({ scheduleNoteVisible: v });
                      },
                    }),
                  )
                : null,
            ...
            el(
              ...
              attrs.scheduleVisible
                ? el(
                    "div",
                    {
                      className: "campaign-hero__schedule",
                      style: scheduleStyle,
                    },
                    attrs.scheduleAlwaysOn
                      ...
                      : el(
                          "p",
                          null,
                          (attrs.scheduleStartDate || "") +
                            (attrs.scheduleEndDate
                              ? " ～ " + attrs.scheduleEndDate
                              : ""),
                        ),
                    attrs.scheduleNoteVisible
                      ? el(
                          "p",
                          { className: "campaign-hero__schedule__note" },
                          __(
                          ...
                          el(
                            "a",
                            { href: "#cpn-detail", className: "scroll" },
                            __("詳細はこちら", "rakutenmusic-theme"),
                          ),
                        )
                      : null,
                  )

$(document).ready(function () {
    ...
    function checkWidth() {
        ...
        if (windowSize <= 768) {
            ...
            $('#page .l-header .btn-apply').html('<button onclick="return gtag_report_conversion(\'https://app.adjust.com/1sb3663y\')" data-ratid="download-btn" data-ratevent="click" data-ratparam="all">アプリをダウンロード</button>');

        } else {
            $('#page .l-header .btn-apply a').attr('href', 'https://app.adjust.com/1sb3663y').text('アプリをダウンロード');
        }
    }

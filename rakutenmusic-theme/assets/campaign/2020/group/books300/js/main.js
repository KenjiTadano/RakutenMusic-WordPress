$(function() {
    ...
    function rankingCallBack03(data) {
        scope = $("#page #items-other .item-list .item__list");
        scope.empty();
    ...
    function showError() {
        scope = $('#page #items-cd .item-list .item__list , #page #items-dvd .item-list .item__list , #page #items-other .item-list .item__list');
        scope.next().remove();
        scope.remove();
        return;
    }

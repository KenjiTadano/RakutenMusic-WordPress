$(function () {
    ...
    $.ajax({
        ...
        url: [
            ...
            'fields=title,person_name,list_price_tax,item_url,image_url',
            'hits=10',
            'stocks=10',
            'onSaleFlag=1',
            'genres=002',
    ...
    function rankingCallBack(data) {
        ...
        for (var i in data.items) {
            ...
            itemPrice = data.items[i].list_price_tax.toLocaleString();
    ...
    $.ajax({
        url: [
            'https://rdc-api-catalog-gateway-api.rakuten.co.jp/books/search-items?sid=19',
            'fields=title,person_name,list_price_tax,item_url,image_url,maker,platform',
            'hits=10',
            'stocks=10',
            'onSaleFlag=1',
            'genres=006',

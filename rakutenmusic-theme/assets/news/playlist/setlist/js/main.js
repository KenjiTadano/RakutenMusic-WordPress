$(function () {
    function init() {
        var request = [
            { url: 'https://music.r10s.jp/external/prod/assets/news/playlist/setlist/csv/setlist_01.csv' },
            { url: 'https://music.r10s.jp/external/prod/assets/news/playlist/setlist/csv/setlist_02.csv' },
            { url: 'https://music.r10s.jp/external/prod/assets/news/playlist/setlist/csv/setlist_03.csv' },
            { url: 'https://music.r10s.jp/external/prod/assets/news/playlist/setlist/csv/setlist_04.csv' },
            { url: 'https://music.r10s.jp/external/prod/assets/news/playlist/setlist/csv/archive.csv' },
        ];
    ...
    function allDone(results) {
        ...
        for (var k = 0; k < 20; k++) {
            ...
            archivePlaylistArtist = tmp2[k].split(",")[1]
            archivePlaylistImage_1 = tmp2[k].split(",")[2]
            archivePlaylistImage_2 = tmp2[k].split(",")[3]
            archivePlaylistImage_3 = tmp2[k].split(",")[4]
            archivePlaylistImage_4 = tmp2[k].split(",")[5]

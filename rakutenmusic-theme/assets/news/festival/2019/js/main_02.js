$(function() {
      ...
      if (i == tmp.length - 2) {
        ...
        otherPlaylists = [
          ...
          },
          {
            ...
            other_playlists: [
              "SWEET LOVE SHOWER 2019 day3(8/31)",
  ...
  function changePlaylist() {
    $(document).on("click", "#page #tab .l-inner ul li", function() {
      var index = $("#page #tab .l-inner ul li").index(this);
  ...
  // var navigationMenuElement = $("#page #tab").clone();
  // var navMenuCloneFlag = false;
  // var navigationMenuOffset = $("#page #tab").offset();
  // var globalNavMenuHeight = $("#page .l-header").outerHeight();

  // console.log(globalNavMenuHeight);
  // $(window).on("scroll", function() {
  //   var ScrTop = $(document).scrollTop();
  //   if (ScrTop > navigationMenuOffset.top) {
  //     if (!navMenuCloneFlag) {
  //       $("#page").append(navigationMenuElement);
  //       navigationMenuElement.fadeIn();
  //       $("#page > #tab").css("top", globalNavMenuHeight + "px");

  //       navMenuCloneFlag = true;
  //     }
  //   } else {
  //     if (navMenuCloneFlag) {
  //       navigationMenuElement.fadeOut();
  //       navMenuCloneFlag = false;
  //     }
  //   }
  // });
});
